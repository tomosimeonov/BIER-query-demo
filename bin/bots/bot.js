...
// Bot
//
var Node = require("BIER-storage").KadOH.logic.KademliaNode;
var SHA1 = require("BIER-storage").KadOH.util.crypto.digest.SHA1;
var Reporter = require(__dirname + '/../../statistics/cube/reporter');
var logging = require("BIER-storage").KadOH.logger.logging;
var ConsoleLogger = require("BIER-storage").KadOH.logger.reporter.Console;
